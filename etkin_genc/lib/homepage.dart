...
class _HomeState extends State<Home> {
  ...
  Future yazigetir() async {
    ...
    String name = getDataAd;
    String surname = getDataSoyad;
  }

  katil() {
    FirebaseFirestore.instance
        .collection("Katılma Talepleri")
        .doc(auth.currentUser!.email)
        .set({
      "KullaniciAd": getDataAd,
      "KullaniciSoyad": getDataSoyad,
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text("Katılma talebin başarıyla oluşturuldu!"),
        actions: [
          MaterialButton(
              child: Text(
                "Tamam",
